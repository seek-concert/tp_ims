...
class NodeModel extends Model
{
    ...
    public function getMenu($nodeStr = '')
    {
        ...
        $result = $this->field('id,node_name,type_id,control_name,action_name,style')
            ->where($where)->order('sort asc,id desc')->select();
    ...
    {
        return $this->field('id,node_name name,type_id pid,is_menu,style,control_name,action_name,sort')->order('sort asc,id desc')->select();
    }
